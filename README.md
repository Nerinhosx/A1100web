...
* Seção informativa: "Por que ensinar tecnologia desde cedo?".
* Área de contato / Assinatura de Newsletter.

## 🛠️ Tecnologias Utilizadas
* HTML5
* CSS3
* JavaScript
* **Git & GitHub/Bitbucket** (Para controle de versão)

## 🔀 Fluxo de Versionamento Aplicado (Atividade 3)
Para atender aos requisitos da atividade prática, este repositório seguiu o seguinte fluxo de trabalho:

1. **Commit Inicial:** Criação da estrutura base do projeto localmente.
2. **Push Remoto:** Envio dos arquivos iniciais para este repositório.
3. **Feature Branch:** Criação de ramificações isoladas (ex: `feature-secao-sobre`) para o desenvolvimento de novos recursos sem comprometer o código principal.
